                ...
                {isEquipmentDropdownOpen && (
                  <div className="absolute left-0 mt-2 w-56 bg-neutral-800/95 backdrop-blur-md rounded-xl shadow-2xl py-3 z-50 border border-neutral-600/50 animate-fadeIn overflow-hidden">
                    ...
                    <div className="relative">
                      ...
                      >
                        <svg
                          className="w-5 h-5 mr-3 text-sky-400 group-hover:text-sky-300"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                ...
                {navLinks.map((link, index) => {
                  ...
                  return (
                    <NavLink
                      key={index}
                      href={link.href}
                      className="block px-4 py-3 rounded-lg hover:bg-white/5 text-white/90 hover:text-white transition-all duration-200"
