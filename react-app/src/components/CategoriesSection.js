  ...
  const categories = [
    {
      ...
      iconPath: "/assets/icons/padel-icon.png", // Replace with your icon path
      href: "#padel",
      status: "available",
    ...
    },
    {
      ...
      iconPath: "/assets/icons/football-icon.png", // Replace with your icon path
      href: "#football",
      status: "available",
    ...
    },
    {
      ...
      iconPath: "/assets/icons/basketball-icon.png", // Replace with your icon path
      href: "#basketball",
      status: "coming-soon",
    ...
    },
    {
      ...
      iconPath: "/assets/icons/tennis-icon.png", // Replace with your icon path
      href: "#tennis",
      status: "coming-soon",
